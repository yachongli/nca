...
from nca._i18n import _LE, _LI
from nca.callbacks import events
from nca.callbacks import registry
from nca.callbacks import resources
from nca.common import config
from nca.common import profiler
from nca.common import rpc as n_rpc
from nca.conf import service
from nca import context
from nca.db import api as session
from nca import worker as nca_worker
...
class NeutronApiService(WsgiService):
    ...
    def __init__(self, app_name):
        profiler.setup('nca-server', cfg.CONF.host)
        super(NeutronApiService, self).__init__(app_name)

    @classmethod
    def create(cls, app_name='nca'):
        # Setup logging early
...
class RpcWorker(nca_worker.NeutronWorker):
...
class AllServicesNeutronWorker(nca_worker.NeutronWorker):
...
class Service(n_rpc.Service):
    ...
    def create(cls, host=None, binary=None, topic=None, manager=None,
        ...
        :param topic: defaults to bin_name - 'nca-' part
    ...
    def report_state(self):
        ...
        # Todo(gongysh) report state to nca server
        pass
