...
from nca.api import versions
from nca.pecan_wsgi import hooks
from nca.pecan_wsgi import startup

CONF = cfg.CONF
CONF.import_opt('bind_host', 'nca.conf.common')
CONF.import_opt('bind_port', 'nca.conf.common')
